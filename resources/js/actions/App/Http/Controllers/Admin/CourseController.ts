 ...
 * @see app/Http/Controllers/Admin/CourseController.php:17
 * @route '/admin/api/courses'
 */
 ...
 * @see app/Http/Controllers/Admin/CourseController.php:29
 * @route '/admin/api/courses'
 */
 ...
 * @see app/Http/Controllers/Admin/CourseController.php:43
 * @route '/admin/api/courses/{course}'
 */
 ...
 * @see app/Http/Controllers/Admin/CourseController.php:52
 * @route '/admin/api/courses/{course}'
 */
...
const CourseController = { index, store, show, update, destroy }
